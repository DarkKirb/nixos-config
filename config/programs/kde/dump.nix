{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-b4547c33-271a-43a2-a926-5dbfc7a22859" = [];
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to German (Neo 2)" = [];
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to German (Neo, QWERTY)" = [];
    ...
    files = {
      ...
      "baloofilerc"."General"."exclude folders[$e]" = "$HOME/,$HOME/";
      "baloofilerc"."General"."only basic indexing" = true;
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."b4547c33-271a-43a2-a926-5dbfc7a22859" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "b4547c33-271a-43a2-a926-5dbfc7a22859";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{034c68e9-e881-4de6-9626-ef24077f7ef2}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{752b9eb6-8a6f-44cf-b03e-39d33b3aebd4}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{371310db-a0b4-42a2-a437-e89b8925a57b}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{0dec90f1-2fb8-4a85-8c37-711b4f4a16c8}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{4829805b-af83-462b-8403-78d3fe3fdf1a}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{0c4f90d7-94a3-47ad-a066-40e34146e953}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{a2b63536-e74b-467e-bb95-5a12e896a424}";
      ...
      "kwinrc"."Desktops"."Id_1" = "449f29dc-7bbd-4c77-868a-a2fb194c9763";
      ...
      "kxkbrc"."Layout"."VariantList" = "neo,neo_qwerty";
      "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/darkkirb/Pictures/Art-bu/2022-06-21-sammythetanuki-lotteplushpride.png";
    };
  };
}
